    ...
    public ItemStack slotClick(int slotId, int dragType, ClickType clickTypeIn, EntityPlayer player) {
        ...
        if (clickTypeIn == ClickType.QUICK_CRAFT)
        {
            ...
            else if (this.dragEvent == 1)
            {
                ...
                if (slot7 != null && (!(itemstack12.getItem() instanceof ItemBundle) || ItemBundle.getItemAmount(itemstack12) <= 0 || dragType != 5) && Container.canAddItemToSlot(slot7, itemstack12, true) && slot7.isItemValid(itemstack12) && (this.dragMode == 2 || itemstack12.getCount() > this.dragSlots.size()) && this.canDragIntoSlot(slot7)) {
            ...
            else if (this.dragEvent == 2)
            {
                if (!this.dragSlots.isEmpty())
                {
                    ...
                    for (Slot slot8 : this.dragSlots)
                    {
                        ...
                        if (slot8 != null && Container.canAddItemToSlot(slot8, itemstack13, true) && slot8.isItemValid(itemstack13) && (this.dragMode == 2 || itemstack13.getCount() >= this.dragSlots.size()) && this.canDragIntoSlot(slot8))
                        {
            ...
            else
            {
                ...
                if (slot6 != null)
                {
                    ...
                    if (itemstack8.isEmpty())
                    {
                        ...
                        else if (!itemstack11.isEmpty() && slot6.isItemValid(itemstack11))
                        {
